...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-west-2:301447236845:cluster:my-aurora-serverless"
  
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-cxcxjresqvyk.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:301447236845:secret:my-aurora-serverless-G1DECf"

  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-301447236845"
}
